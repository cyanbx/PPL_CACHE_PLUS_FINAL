...
HD_PWD='C:/Cyanbox/curriculum/arch/RISC-V_lab/PPL_CACHE_PLUS_changesize_stage2/ArchTestUtils.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arch_top.tcl
