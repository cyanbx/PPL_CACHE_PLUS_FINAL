...
HD_PWD='C:/Cyanbox/curriculum/arch/RISC-V_lab/PPL_CACHE_PLUS_changesize_stage2/ArchTestUtils.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arch_top.tcl -notrace
