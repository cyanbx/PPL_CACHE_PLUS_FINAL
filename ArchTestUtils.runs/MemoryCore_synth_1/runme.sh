...
HD_PWD='C:/Cyanbox/curriculum/arch/RISC-V_lab/PPL_CACHE_PLUS/ArchTestUtils.runs/MemoryCore_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryCore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemoryCore.tcl
