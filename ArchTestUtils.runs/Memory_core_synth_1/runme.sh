...
HD_PWD='C:/Cyanbox/curriculum/arch/RISC-V_lab/PPL_CACHE_PLUS_changesize_stage2/ArchTestUtils.runs/Memory_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Memory_core.tcl
