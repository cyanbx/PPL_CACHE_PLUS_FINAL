...
#
# Generated by Vivado on Wed Dec 23 16:23:36 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Cyanbox/curriculum/arch/RISC-V_lab/PPL_CACHE/ArchTestUtils.cache/compile_simlib/activehdl"
  fi
